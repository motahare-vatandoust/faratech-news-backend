...
@router.post("/smashingmagazine/sync", response_model=CrawlResponse)
async def sync_smashingmagazine_news(
    db: Session = Depends(get_db),
    limit: Optional[int] = Query(default=None, ge=1, le=100),
    translate_to_farsi: bool = Query(
        default=True,
    ...
    """Crawl Smashing Magazine, translate to Farsi, and save new articles."""
    result, saved_count = await crawler_service.sync_smashingmagazine(
        db, limit=limit, translate_to_farsi=translate_to_farsi
    )
...
@router.post("/nngroup/sync", response_model=CrawlResponse)
async def sync_nngroup_news(
    db: Session = Depends(get_db),
    limit: Optional[int] = Query(default=None, ge=1, le=100),
    translate_to_farsi: bool = Query(
        default=True,
    ...
    """Crawl NN/g articles, translate to Farsi, and save new articles."""
    result, saved_count = await crawler_service.sync_nngroup(
        db, limit=limit, translate_to_farsi=translate_to_farsi
    )
...
@router.post("/designmilk/sync", response_model=CrawlResponse)
async def sync_designmilk_news(
    db: Session = Depends(get_db),
    limit: Optional[int] = Query(default=None, ge=1, le=100),
    translate_to_farsi: bool = Query(
        default=True,
    ...
    """Crawl Design Milk, translate to Farsi, and save new articles."""
    result, saved_count = await crawler_service.sync_designmilk(
        db, limit=limit, translate_to_farsi=translate_to_farsi
    )
...
@router.post("/creativebloq/sync", response_model=CrawlResponse)
async def sync_creativebloq_news(
    db: Session = Depends(get_db),
    limit: Optional[int] = Query(default=None, ge=1, le=100),
    translate_to_farsi: bool = Query(
        default=True,
    ...
    """Crawl Creative Bloq, translate to Farsi, and save new articles."""
    result, saved_count = await crawler_service.sync_creativebloq(
        db, limit=limit, translate_to_farsi=translate_to_farsi
    )
...
@router.post("/itsnicethat/sync", response_model=CrawlResponse)
async def sync_itsnicethat_news(
    db: Session = Depends(get_db),
    limit: Optional[int] = Query(default=None, ge=1, le=100),
    translate_to_farsi: bool = Query(
        default=True,
    ...
    """Crawl It's Nice That, translate to Farsi, and save new articles."""
    result, saved_count = await crawler_service.sync_itsnicethat(
        db, limit=limit, translate_to_farsi=translate_to_farsi
    )
